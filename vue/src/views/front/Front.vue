  ...
  <div>
    ...
    <div style="display: flex; height: 100px; line-height: 60px; border-bottom: 1px solid #eee">
      <div style="width: 300px; display: flex; padding-left: 30px">
        ...
        <div style="flex: 1;padding-left: 40px;padding-top: 10px;font-size:large;line-height: 2;">内蒙古农业大学<br>OA办公系统</div>
      </div>
      <div style="flex: 1;margin-top: 10px; margin-bottom: 10px">
        <el-card style="height: 80px;text-align: center;display: flex; justify-content: center">
          <template>
